...
import {
	selectTotalBetAmount,
	selectBetMax,
	selectCurrentlySelectedCard,
	selectGameId,
	postCardBet,
...
import type { CardBetRequestBody } from '../../../services/api-functions';
...
export default function MakeBetForm() {
	...
	const submitData = (data: FieldValues) => {
		const betData = { currentCard: currentlySelectedCard, ...data } as CardBetRequestBody;
		dispatch(postCardBet({ gameId: gameId ?? '', betData }));
			...
			<Modal aria-label="Place your bet" aria-labelledby="makebet-heading">
				<div className="makebet-form">
					...
					<form onSubmit={handleSubmit(submitData)}>
						...
						/>
						<button type="submit" className="makebet-form__button">
							Submit Bet
						</button>
					</form>
				</div>
