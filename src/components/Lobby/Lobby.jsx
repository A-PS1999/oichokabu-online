...
import { lobbySelector, fetchGames, fetchUserIdAndChips, joinGame, resetUserChips } from '../../store/lobbySlice.js';
							...
							return (
								<React.Fragment key={room.game_id}>
									<div className="lobby-body__room">
										...
										<button className="lobby-body__room__button" onClick={() => dispatch(joinGame(room.game_id))} disabled={room.Players.length === room.player_cap || chips < 100}>
											Join Game
										</button>
									</div>
								</React.Fragment>
