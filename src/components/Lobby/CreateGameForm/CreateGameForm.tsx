...
import { lobbySelector, createNewGame, lobbyStateReset as clearState } from '../../../store/lobbySlice';
...
import type { NewGamePayload } from '../../../services/api-functions';
...
export default function CreateGameForm() {
	...
	const submitData = (data: FieldValues) => {
		dispatch(createNewGame(data as NewGamePayload));
	};
					...
					<form onSubmit={handleSubmit(submitData)}>
						...
						<Controller
							...
							render={({ field: { onChange, value } }) => (
								<GameFormRadioGroup currValue={value} onChange={onChange} />
							)}
						/>
