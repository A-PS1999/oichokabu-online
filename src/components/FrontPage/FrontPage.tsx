			...
			<div>
				<header className="frontpage-header">
					<div className="frontpage-header__text-box">
						<h1 className="heading-primary">Oicho Kabu Online</h1>
				...
				<main>
					<section className="section-about">
						...
						<div>
							<p className="paragraph">
								...
								Baccarat. Oicho Kabu is usually played with a 40 card deck of{' '}
								<em>kabufuda </em>
								cards specifically designed for the game, though hanafuda cards can also be used.
							</p>
							<div className="section-about__subheading">Want to know how it's played?</div>
					...
					<section className="section-trivia">
						<h2 className="section-trivia__heading">Did you know?</h2>
						<div className="card">
							<div className="card__inner">
								...
								<div className="card__side card__side--back">
									<div className="card__back-container">
										The worst hand in Oicho Kabu is an eight, a nine and a three. This can be
										expressed as "ya-ku-za". This is where the Japanese word for "gangster"
										comes from.
									</div>
								</div>
							</div>
